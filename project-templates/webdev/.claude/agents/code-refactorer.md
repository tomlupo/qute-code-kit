...
description: Improve existing code structure, readability, and maintainability without changing functionality. Use for cleaning up messy code, reducing duplication, improving naming, simplifying complex logic.
model: sonnet
