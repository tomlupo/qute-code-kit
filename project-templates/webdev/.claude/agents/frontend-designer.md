...
description: Convert design mockups, wireframes, or visual concepts into technical specs, component architectures, and design systems for frontend development.
model: sonnet
