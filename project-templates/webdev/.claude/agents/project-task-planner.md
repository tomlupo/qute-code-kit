...
description: Create comprehensive development task lists from a PRD. Analyzes requirements and generates structured tasks covering setup, backend, frontend, testing, deployment, and maintenance.
model: sonnet
