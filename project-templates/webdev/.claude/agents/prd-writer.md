---
name: prd-writer
description: Create comprehensive Product Requirements Documents (PRDs) with business goals, user personas, functional requirements, user experience flows, success metrics, and user stories.
model: sonnet
