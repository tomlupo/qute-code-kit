---
name: guard
description: Toggle qute-essentials security guards (lakera, langfuse, secrets, audit, destructive, git-workflow, provenance) or show status. Triggers — "guards on/off", "turn off lakera", "disable langfuse", "let me commit to main", "is X enabled", "guard status".
