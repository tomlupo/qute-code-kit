...
class FinancialDataFetcher:
    ...
    def _request(
        ...
        while True:
            ...
            if response.status_code == 429:
                raise ValueError(
                    "FinancialData.Net rate limit exceeded. Wait and retry."
                )
    ...
    def fetch(
        ...
        **kwargs,
        ...
        try:
            start_display = (
                normalize_date_display(start_date) if start_date else "earliest"
            )
    ...
    def get_minute_prices(self, ticker: str, trade_date: str) -> pd.DataFrame:
    ...
    def get_income_statements(self, ticker: str, period: str = "year") -> pd.DataFrame:
        """Fetch income statements (period: 'year' or 'quarter')."""
        return self.fetch(ticker, endpoint="income-statements", period=period)

    def get_balance_sheet(self, ticker: str, period: str = "year") -> pd.DataFrame:
    ...
    def get_cash_flow(self, ticker: str, period: str = "year") -> pd.DataFrame:
