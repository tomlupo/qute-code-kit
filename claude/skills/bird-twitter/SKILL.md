...
```bash
bash .claude/skills/bird-twitter/scripts/bird.sh <command>
```

### Fetch Bookmarks
```bash
# Default 20 bookmarks
bash .claude/skills/bird-twitter/scripts/bird.sh bookmarks

# Specific count (1-100)
bash .claude/skills/bird-twitter/scripts/bird.sh bookmarks 5
```

### Search Tweets
```bash
# Basic search (default 10 results)
bash .claude/skills/bird-twitter/scripts/bird.sh search "quantitative trading"

# With count (1-50)
bash .claude/skills/bird-twitter/scripts/bird.sh search "#fintwit momentum" 20

# Research-oriented searches
bash .claude/skills/bird-twitter/scripts/bird.sh search "mean reversion strategy" 15
bash .claude/skills/bird-twitter/scripts/bird.sh search "from:AQRCapital" 10
```
