...
# Also stage the derived plugin manifest (regenerated by build-marketplace.py).
derived_manifest="plugins/${plugin}/.claude-plugin/plugin.json"
[ -f "$derived_manifest" ] && files_to_stage+=("$derived_manifest")
