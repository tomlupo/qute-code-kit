...
| wtf | `/wtf` | User is furious or incredulous at LLM/assistant output |
...
|--------|--------|--------------|
| qute-essentials | qute-marketplace | Hooks: ruff, doc-enforcer, skill-eval, notifications. Skills: commits, worktrees, handoff, readme, gbu, wtf |
